...
<div class="wrapper" id="wrapper">
  ...
  <div class="btn-warning"  ><h4 style="margin-left:10px; vertical-align:middle; color:#fff; padding-top:10px;">All Wishlist Items</h4></div>
...
<th scope="col">Item Name</th>
  ...
  <tbody>
    <tr><?php $query=mysqli_query($con,"SELECT * from admindata order by ad_id desc ");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
 ?>
      ...
      <td  style="display:<?php echo $row['pro_cat']==1 ? 'block':'none' ?>">
