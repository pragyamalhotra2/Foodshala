...
<div class="wrapper" id="wrapper">
  ...
  <div class="btn-success"  ><h4 style="margin-left:10px; vertical-align:middle; color:#fff; padding-top:10px;">My Wishlist</h4></div>
...
<th scope="col">#</th>
  ...
  <tbody>
    <tr><?php $query=mysqli_query($con,"SELECT * from userreview
where usermail='".$_SESSION['user']['username']."'    order by u_id desc ");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
 ?>
      ...
      <td><?php echo $cnt;?></td>
      <td   >
       <img src="upload/<?php echo $row['imagename']?>" width="200" height="150" style="padding:12px; border:1px solid #c3bfbf;" class="img-responsive"></td>

        
   
      <td style=" vertical-align: middle;">
      <div class="row" style="max-width:300px; padding:15px;">
      Rs. <?php echo $row['category']?>
      ...
      <td style=" vertical-align: middle;"><button class="btn btn-danger btn-sm remove dlt"  >Edit Order</button>
       </p></td>
    </tr>
  <?php $cnt=$cnt+1;
} ?>
